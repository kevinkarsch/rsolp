function out = LBP_riu81_img(X)

%Returns rotation invariant LBP (uniform patterns) values of picture X.
%number of interpolated pixels = 8 -> 10 possible values
%
%The size of input picture X must be at least 5X5 pixels
